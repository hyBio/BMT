...
# @Author : huyan
# @FileName: Admin.py
# @Function: 该模块为管理员用来管理所有的用户信息的模块，只有管理员才能进入，且管理员的账号一定为 admin，数据库中必含有admin这个账号名，如果被删除，会自动生成默认的admin及默认密码 admin123
...
class AdminWindow(QWidget):
    ...
    def set_ui(self):
        self.setWindowTitle("BMT Management page")
        self.setFixedSize(1200, 900)
        self.font = QFont("Consolas")
        self.setFont(self.font)
        icon = QIcon()
        icon.addPixmap(QPixmap(":/ico/resource/BMT_64.ico"), QIcon.Normal, QIcon.Off)
    ...
    def add_button(self):
        ...
        self.quit_button.setToolTip("Click here and you will quit the admin interface")
