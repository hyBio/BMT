...
class Ui_BMT_client_main_windows(object):
    def setupUi(self, BMT_client_main_windows):
        ...
        BMT_client_main_windows.resize(1380, 950)
        BMT_client_main_windows.setMaximumSize(QtCore.QSize(1380, 950))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.client_name.setGeometry(QtCore.QRect(180, 30, 91, 50))
        font = QtGui.QFont()
        ...
        self.table.setGeometry(QtCore.QRect(20, 110, 731, 641))
        font = QtGui.QFont()
        ...
        self.date_time.setGeometry(QtCore.QRect(870, 10, 411, 30))
        font = QtGui.QFont()
        ...
        self.today_sales.setGeometry(QtCore.QRect(30, 770, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.today_pay.setGeometry(QtCore.QRect(30, 810, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.today_profit.setGeometry(QtCore.QRect(30, 850, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.total_profit.setGeometry(QtCore.QRect(350, 850, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.total_sales.setGeometry(QtCore.QRect(350, 770, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.total_pay.setGeometry(QtCore.QRect(350, 810, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.today_sales_plot.setGeometry(QtCore.QRect(760, 40, 300, 300))
        ...
        self.total_sales_plot.setGeometry(QtCore.QRect(760, 350, 300, 300))
        ...
        self.today_pay_plot.setGeometry(QtCore.QRect(1070, 40, 300, 300))
        ...
        self.total_pay_plot.setGeometry(QtCore.QRect(1070, 350, 300, 300))
        ...
        self.time_from.setGeometry(QtCore.QRect(290, 20, 300, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.time_to.setGeometry(QtCore.QRect(290, 60, 300, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.refresh.setGeometry(QtCore.QRect(610, 20, 61, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.sales_trend_plot.setGeometry(QtCore.QRect(760, 660, 610, 280))
        ...
        self.increase_inventory.setGeometry(QtCore.QRect(610, 60, 131, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.call_for_help.setGeometry(QtCore.QRect(460, 910, 180, 30))
        font = QtGui.QFont()
        ...
        self.back.setGeometry(QtCore.QRect(350, 910, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.client_logo.setGeometry(QtCore.QRect(70, -10, 128, 128))
        self.client_logo.setObjectName("client_logo")
        self.pricechange = QtWidgets.QPushButton(self.centralwidget)
        self.pricechange.setGeometry(QtCore.QRect(240, 910, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        self.pricechange.setFont(font)
        self.pricechange.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, BMT_client_main_windows):
        ...
        self.pricechange.setText(_translate("BMT_client_main_windows", "修改售价"))
import resource_rc
