...
class Ui_BMT_client_main_windows(object):
    def setupUi(self, BMT_client_main_windows):
        ...
        self.table.setGeometry(QtCore.QRect(49, 70, 861, 861))
        font = QtGui.QFont()
        ...
        self.refresh.setGeometry(QtCore.QRect(840, 30, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.pricechange.setGeometry(QtCore.QRect(500, 940, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.Increase_inventory.setGeometry(QtCore.QRect(660, 940, 150, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
