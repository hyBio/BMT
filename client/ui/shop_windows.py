...
class Ui_BMT_client_main_windows(object):
    def setupUi(self, BMT_client_main_windows):
        ...
        BMT_client_main_windows.resize(1380, 900)
        BMT_client_main_windows.setMaximumSize(QtCore.QSize(1380, 900))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.table.setGeometry(QtCore.QRect(20, 110, 731, 581))
        font = QtGui.QFont()
        ...
        self.date_time.setGeometry(QtCore.QRect(850, 10, 411, 30))
        font = QtGui.QFont()
        ...
        self.today_sales.setGeometry(QtCore.QRect(30, 710, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.today_pay.setGeometry(QtCore.QRect(30, 750, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.today_profit.setGeometry(QtCore.QRect(30, 790, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.total_profit.setGeometry(QtCore.QRect(350, 790, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.total_sales.setGeometry(QtCore.QRect(350, 710, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.total_pay.setGeometry(QtCore.QRect(350, 750, 250, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.today_sales_plot.setGeometry(QtCore.QRect(760, 60, 300, 300))
        ...
        self.total_sales_plot.setGeometry(QtCore.QRect(760, 370, 300, 300))
        ...
        self.today_pay_plot.setGeometry(QtCore.QRect(1070, 60, 300, 300))
        ...
        self.total_pay_plot.setGeometry(QtCore.QRect(1070, 370, 300, 300))
        ...
        self.refresh.setGeometry(QtCore.QRect(610, 20, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.sales_trend_plot.setGeometry(QtCore.QRect(760, 680, 611, 211))
        ...
        self.call_for_help.setGeometry(QtCore.QRect(460, 850, 180, 30))
        font = QtGui.QFont()
        ...
        self.back.setGeometry(QtCore.QRect(350, 850, 90, 30))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        font.setBold(False)
